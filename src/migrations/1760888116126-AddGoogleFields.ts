...
export class AddGoogleFields1760888116126 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "refresh_tokens" DROP COLUMN "is_active"`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" DROP COLUMN "device_info"`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD "is_revoked" boolean NOT NULL DEFAULT true`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD "device_info" jsonb`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD "is_active" boolean NOT NULL DEFAULT true`);
